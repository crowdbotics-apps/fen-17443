...
admin.site.site_header = "FEN"
admin.site.site_title = "FEN Admin Portal"
admin.site.index_title = "FEN Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="FEN API",
        default_version="v1",
        description="API documentation for FEN App",
    ),
    public=True,
